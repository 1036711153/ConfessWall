package com.confress.lovewall.view.CustomView.RoundImage;
 ...
 * @author Alan
 */
public class HttpRoundImageView extends ImageView {
	...
	public HttpRoundImageView(Context context) {
		super(context);
		mContext = context;
	}

	public HttpRoundImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		setCustomAttributes(attrs);
	}

	public HttpRoundImageView(Context context, AttributeSet attrs, int defStyle) {
